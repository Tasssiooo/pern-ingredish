...
import Navigation from "@/layouts/MobileNavBar/components/Navigation";

export default function NavDrawer() {
  return (
    <Drawer>
      <DrawerTrigger title="Open navigation drawer" className="sm:hidden">
        <HamburgerMenuIcon color="hsl(var(--primary-foreground))" />
      </DrawerTrigger>
      <DrawerContent>
